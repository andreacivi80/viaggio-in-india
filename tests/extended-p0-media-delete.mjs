...
postForm.append("files", new Blob([new Uint8Array([0xff, 0xd8, 0xff, 0xd9])], { type: "image/jpeg" }), "p0-foto.jpg");
...
for (const media of post.media)
  assert.equal((await request(media.media_url, { method: "HEAD", headers: owner })).status, 200);
