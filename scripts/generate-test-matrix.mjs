...
const evidence = {
  ...
  "T-0649": ["SUPERATO", "ui-network-india: eSIM 4G verificata sui tre profili mobile"],
  "T-0650": ["SUPERATO", "ui-network-india: Wi-Fi indiana debole verificata sui tre profili mobile"],
  "T-0651": ["SUPERATO", "ui-network-india: roaming congestionato verificato sui tre profili mobile"],
  "T-0652": ["SUPERATO", "ui-network-india: SIM indiana 3G verificata sui tre profili mobile"],
  ...
  "T-1558": ["SUPERATO", "security-audit + authorization-matrix 86/86 ripetuta due volte: ogni evento personale registra il dispositivo della sessione"],
  "T-1569": ["SUPERATO", "security-audit 3/3 + authorization-matrix 86/86: contenuto e nome del PDF assenti da schema e risposta coordinatore"],
  "T-1570": ["SUPERATO", "security-audit 3/3 + authorization-matrix 86/86: token sessione e invito assenti dal registro"],
  "T-1571": ["SUPERATO", "security-audit 3/3 + authorization-matrix 86/86: password del gruppo assente dal registro"],
