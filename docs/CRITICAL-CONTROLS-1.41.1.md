...
Controlli selezionati: **7** tra 7 controlli P0–P2 ancora privi di evidenza conclusiva.
Stato del pacchetto: **0 superati**, **7 pendenti**.
...
- [ ] **K-007 · mappe-posizione** — Misurare batteria con mappa aperta.
