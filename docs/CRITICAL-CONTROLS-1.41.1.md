...
Controlli selezionati: **3** tra 3 controlli P0–P2 ancora privi di evidenza conclusiva.
Stato del pacchetto: **0 superati**, **3 pendenti**.
...
- [ ] **K-002 · usabilita-mobile** — Test Push su iPhone con PWA installata.
  Sorgente: `globale:T-0097`. I flussi fondamentali devono restare raggiungibili e azionabili tramite touch.
- [ ] **K-003 · usabilita-mobile** — Utilizzare l’app in automobile come passeggero.
